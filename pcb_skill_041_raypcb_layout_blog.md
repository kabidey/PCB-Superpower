# SKILL: RayPCB Layout Blog

## Skill Metadata
- **ID**: 41
- **Category**: manufacturing_dfm
- **Source**: RayPCB Layout Blog
- **URL**: https://www.raypcb.com/
- **Description**: Practical walk-throughs focused on optimizing SMT component layouts to clear Automated Optical Inspection (AOI) criteria.
- **Soul**: The AOI compliance - if the machine can't see it, the machine can't build it.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The RayPCB Layout Blog Perspective

**Core Belief:** The AOI compliance - if the machine can't see it, the machine can't build it.
...
**Core Technical Analysis (from RayPCB Layout Blog):**
...
**Verification Checklist (from RayPCB Layout Blog):**
...
### The Failure Modes of RayPCB Layout Blog
...
### The RayPCB Layout Blog Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like RayPCB Layout Blog — see the invisible, question the obvious
