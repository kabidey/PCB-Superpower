# SKILL: EEWeb Signal Integrity

## Skill Metadata
- **ID**: 23
- **Category**: signal_integrity
- **Source**: EEWeb Signal Integrity
- **URL**: https://www.eeweb.com/
- **Description**: Community-sourced technical notes breaking down differential pair routing and high-speed bus design.
- **Soul**: The community knowledge - no one person knows everything, but the community knows enough.
- **Complexity**: Advanced
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The EEWeb Signal Integrity Perspective

**Core Belief:** The community knowledge - no one person knows everything, but the community knows enough.
...
**Core Technical Analysis (from EEWeb Signal Integrity):**
...
**Verification Checklist (from EEWeb Signal Integrity):**
...
### The Failure Modes of EEWeb Signal Integrity
...
### The EEWeb Signal Integrity Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like EEWeb Signal Integrity — see the invisible, question the obvious
