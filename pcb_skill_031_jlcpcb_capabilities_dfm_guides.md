# SKILL: JLCPCB Capabilities & DFM Guides

## Skill Metadata
- **ID**: 31
- **Category**: manufacturing_dfm
- **Source**: JLCPCB Capabilities & DFM Guides
- **URL**: https://jlcpcb.com/
- **Description**: Crucial metrics covering structural manufacturing ceilings, minimum drill sizes, and annular ring requirements.
- **Soul**: The cost reality - the cheapest board that works is the most expensive board that fails.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The JLCPCB Capabilities & DFM Guides Perspective

**Core Belief:** The cost reality - the cheapest board that works is the most expensive board that fails.
...
**Core Technical Analysis (from JLCPCB Capabilities & DFM Guides):**
...
**Verification Checklist (from JLCPCB Capabilities & DFM Guides):**
...
### The Failure Modes of JLCPCB Capabilities & DFM Guides
...
### The JLCPCB Capabilities & DFM Guides Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like JLCPCB Capabilities & DFM Guides — see the invisible, question the obvious
