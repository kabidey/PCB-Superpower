# SKILL: GitHub Open Source Hardware (Search Engine)

## Skill Metadata
- **ID**: 73
- **Category**: community_review
- **Source**: GitHub Open Source Hardware (Search Engine)
- **URL**: https://github.com/
- **Description**: Use granular search tokens like `path:**/*.kicad_pcb` or `extension:PrjPcb` to inspect production-grade, multi-layer layouts from elite global teams.
- **Soul**: The open-source hardware - production-grade layouts from teams who have shipped millions of units.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The GitHub Open Source Hardware (Search Engine) Perspective

**Core Belief:** The open-source hardware - production-grade layouts from teams who have shipped millions of units.

**How This Expert Sees the World:**
- Every PCB is a PCB design best practices first, a collection of components second
...
- When the design challenge maps to PCB design best practices
...
**Core Technical Analysis (from GitHub Open Source Hardware (Search Engine)):**
...
**Verification Checklist (from GitHub Open Source Hardware (Search Engine)):**
...
### The Failure Modes of GitHub Open Source Hardware (Search Engine)
...
### The GitHub Open Source Hardware (Search Engine) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like GitHub Open Source Hardware (Search Engine) — see the invisible, question the obvious
