# SKILL: Contextual Electronics

## Skill Metadata
- **ID**: 4
- **Category**: learning_platforms
- **Source**: Contextual Electronics
- **URL**: https://contextualelectronics.com/
- **Description**: Chris Gammell’s highly practical, project-based engineering courses designed to take you from a blank canvas to physical hardware.
- **Soul**: The journey from blank canvas to physical hardware - every step matters, and skipping steps kills projects.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Contextual Electronics Perspective

**Core Belief:** The journey from blank canvas to physical hardware - every step matters, and skipping steps kills projects.
...
**Core Technical Analysis (from Contextual Electronics):**
...
**Verification Checklist (from Contextual Electronics):**
...
### The Failure Modes of Contextual Electronics
...
### The Contextual Electronics Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Contextual Electronics — see the invisible, question the obvious
