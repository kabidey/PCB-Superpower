# SKILL: Intel High-Speed PCB Layout Guidelines

## Skill Metadata
- **ID**: 24
- **Category**: signal_integrity
- **Source**: Intel High-Speed PCB Layout Guidelines
- **URL**: https://www.intel.com/
- **Description**: Publicly accessible system hardware engineering blueprints for routing high-frequency platforms like PCIe, DDR3/DDR4/DDR5, and USB-C.
- **Soul**: The platform compliance - Intel doesn't suggest, Intel specifies. Deviation is at your own risk.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Intel High-Speed PCB Layout Guidelines Perspective

**Core Belief:** The platform compliance - Intel doesn't suggest, Intel specifies. Deviation is at your own risk.
...
**Core Technical Analysis (from Intel High-Speed PCB Layout Guidelines):**
...
**Verification Checklist (from Intel High-Speed PCB Layout Guidelines):**
...
### The Failure Modes of Intel High-Speed PCB Layout Guidelines
...
### The Intel High-Speed PCB Layout Guidelines Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Intel High-Speed PCB Layout Guidelines — see the invisible, question the obvious
