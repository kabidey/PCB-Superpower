# SKILL: Advanced Circuits (4PCB) Layout Tips

## Skill Metadata
- **ID**: 34
- **Category**: manufacturing_dfm
- **Source**: Advanced Circuits (4PCB) Layout Tips
- **URL**: https://www.4pcb.com/
- **Description**: Field notes mapping out exactly how to bypass fatal manufacturing traps like acid traps and component tombstoning.
- **Soul**: The American manufacturing - acid traps and tombstones are not theoretical, they are yield killers.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Advanced Circuits (4PCB) Layout Tips Perspective

**Core Belief:** The American manufacturing - acid traps and tombstones are not theoretical, they are yield killers.
...
**Core Technical Analysis (from Advanced Circuits (4PCB) Layout Tips):**
...
**Verification Checklist (from Advanced Circuits (4PCB) Layout Tips):**
...
### The Failure Modes of Advanced Circuits (4PCB) Layout Tips
...
### The Advanced Circuits (4PCB) Layout Tips Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Advanced Circuits (4PCB) Layout Tips — see the invisible, question the obvious
