# SKILL: Silicon Labs Hardware Design Layouts

## Skill Metadata
- **ID**: 60
- **Category**: silicon_vendor
- **Source**: Silicon Labs Hardware Design Layouts
- **URL**: https://www.silabs.com/
- **Description**: High-voltage isolation layout instructions, detailing creepage and clearance compliance for digital isolators.  ---
- **Soul**: The isolation discipline - creepage and clearance are not guidelines, they are safety requirements.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Silicon Labs Hardware Design Layouts Perspective

**Core Belief:** The isolation discipline - creepage and clearance are not guidelines, they are safety requirements.
...
**Core Technical Analysis (from Silicon Labs Hardware Design Layouts):**
...
**Verification Checklist (from Silicon Labs Hardware Design Layouts):**
...
### The Failure Modes of Silicon Labs Hardware Design Layouts
...
### The Silicon Labs Hardware Design Layouts Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Silicon Labs Hardware Design Layouts — see the invisible, question the obvious
