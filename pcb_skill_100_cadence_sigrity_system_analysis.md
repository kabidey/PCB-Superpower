# SKILL: Cadence Sigrity System Analysis

## Skill Metadata
- **ID**: 100
- **Category**: eda_simulation
- **Source**: Cadence Sigrity System Analysis
- **URL**: https://www.cadence.com/
- **Description**: Highly advanced industrial documentation showing how to build scattering parameter (S-parameter) models and verify Power Delivery Network (PDN) impedance across plane splits.
- **Soul**: The high-end workflow - constraint-driven routing is not automation, it's intelligent guidance.
- **Complexity**: Advanced
- **Confidence Threshold**: 0.85

## MENTAL MODEL (How to Think Like This Expert)
### The Cadence Sigrity System Analysis Perspective

**Core Belief:** The high-end workflow - constraint-driven routing is not automation, it's intelligent guidance.

**How This Expert Sees the World:**
- Every PCB is a impedance matching first, a collection of components second
- The invisible (power delivery network) matters more than the visible (traces and pads)
...
**Core Technical Analysis (from Cadence Sigrity System Analysis):**
...
**Verification Checklist (from Cadence Sigrity System Analysis):**
...
### The Failure Modes of Cadence Sigrity System Analysis
...
### The Cadence Sigrity System Analysis Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Cadence Sigrity System Analysis — see the invisible, question the obvious
