# SKILL: W0QE RF Design (Technical Articles)

## Skill Metadata
- **ID**: 88
- **Category**: standards_calculations
- **Source**: W0QE RF Design (Technical Articles)
- **URL**: https://www.w0qe.com/
- **Description**: Exceptional layout notes covering amateur radio, impedance matching networks, and Smith Chart transformations.
- **Soul**: The amateur radio - RF design from people who build and test, not just simulate.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The W0QE RF Design (Technical Articles) Perspective

**Core Belief:** The amateur radio - RF design from people who build and test, not just simulate.
...
**Core Technical Analysis (from W0QE RF Design (Technical Articles)):**
...
**Verification Checklist (from W0QE RF Design (Technical Articles)):**
...
### The Failure Modes of W0QE RF Design (Technical Articles)
...
### The W0QE RF Design (Technical Articles) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like W0QE RF Design (Technical Articles) — see the invisible, question the obvious
