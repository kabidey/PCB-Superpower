# SKILL: PCB Cart Design Resource

## Skill Metadata
- **ID**: 42
- **Category**: manufacturing_dfm
- **Source**: PCB Cart Design Resource
- **URL**: https://www.pcbcart.com/
- **Description**: Transparent breakdowns illustrating how manual component layout choices dictate downstream production costs.
- **Soul**: The unique perspective of PCB Cart Design Resource - a lens through which PCB design problems are seen, analyzed, and solved.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The PCB Cart Design Resource Perspective

**Core Belief:** The unique perspective of PCB Cart Design Resource - a lens through which PCB design problems are seen, analyzed, and solved.
...
**Core Technical Analysis (from PCB Cart Design Resource):**
...
**Verification Checklist (from PCB Cart Design Resource):**
...
### The Failure Modes of PCB Cart Design Resource
...
### The PCB Cart Design Resource Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like PCB Cart Design Resource — see the invisible, question the obvious
