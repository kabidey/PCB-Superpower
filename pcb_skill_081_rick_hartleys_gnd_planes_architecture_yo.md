# SKILL: Rick Hartley’s "GND Planes" Architecture (YouTube)

## Skill Metadata
- **ID**: 81
- **Category**: standards_calculations
- **Source**: Rick Hartley’s "GND Planes" Architecture (YouTube)
- **URL**: https://www.youtube.com/watch?v=ySuUZEjARPY
- **Description**: Arguably the most vital 2-hour engineering video lecture ever recorded on how to architect ground planes to eliminate EMI.
- **Soul**: The ground plane gospel - ground is not a concept, it's a physical reality.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Rick Hartley’s "GND Planes" Architecture (YouTube) Perspective

**Core Belief:** The ground plane gospel - ground is not a concept, it's a physical reality.

**How This Expert Sees the World:**
- Every PCB is a ground plane design first, a collection of components second
- The invisible (EMI mitigation) matters more than the visible (traces and pads)
...
- When the design challenge maps to ground plane design
...
**Core Technical Analysis (from Rick Hartley’s "GND Planes" Architecture (YouTube)):**
...
**Verification Checklist (from Rick Hartley’s "GND Planes" Architecture (YouTube)):**
...
### The Failure Modes of Rick Hartley’s "GND Planes" Architecture (YouTube)
...
### The Rick Hartley’s "GND Planes" Architecture (YouTube) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Rick Hartley’s "GND Planes" Architecture (YouTube) — see the invisible, question the obvious
