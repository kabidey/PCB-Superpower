# SKILL: Würth Elektronik Component Selection & Layout

## Skill Metadata
- **ID**: 58
- **Category**: silicon_vendor
- **Source**: Würth Elektronik Component Selection & Layout
- **URL**: https://www.we-online.com/
- **Description**: Practical field manuals explaining EMI mitigation, ferrite bead deployment, and switching inductor loop layouts.
- **Soul**: The EMI mitigation - ferrite beads are not decorations, they are frequency-selective resistors.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Würth Elektronik Component Selection & Layout Perspective

**Core Belief:** The EMI mitigation - ferrite beads are not decorations, they are frequency-selective resistors.
...
**Core Technical Analysis (from Würth Elektronik Component Selection & Layout):**
...
**Verification Checklist (from Würth Elektronik Component Selection & Layout):**
...
### The Failure Modes of Würth Elektronik Component Selection & Layout
...
### The Würth Elektronik Component Selection & Layout Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Würth Elektronik Component Selection & Layout — see the invisible, question the obvious
