# SKILL: Epec Engineered Components Blog

## Skill Metadata
- **ID**: 40
- **Category**: manufacturing_dfm
- **Source**: Epec Engineered Components Blog
- **URL**: https://www.epectec.com/blog/
- **Description**: Deep technical guidance focused on heavy copper layouts, custom thermal management, and busbars.
- **Soul**: The heavy copper - when current flows like a river, traces become busbars.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Epec Engineered Components Blog Perspective

**Core Belief:** The heavy copper - when current flows like a river, traces become busbars.

**How This Expert Sees the World:**
- Every PCB is a thermal management first, a collection of components second
...
- When the design challenge maps to thermal management
...
**Core Technical Analysis (from Epec Engineered Components Blog):**
...
**Verification Checklist (from Epec Engineered Components Blog):**
...
### The Failure Modes of Epec Engineered Components Blog
...
### The Epec Engineered Components Blog Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Epec Engineered Components Blog — see the invisible, question the obvious
