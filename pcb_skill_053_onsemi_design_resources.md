# SKILL: onsemi Design Resources

## Skill Metadata
- **ID**: 53
- **Category**: silicon_vendor
- **Source**: onsemi Design Resources
- **URL**: https://www.onsemi.com/
- **Description**: Essential layout patterns for power management chips, concentrating on tight loop routing and thermal dissipation paths.
- **Soul**: The thermal path - heat is not a byproduct, it's a design parameter.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The onsemi Design Resources Perspective

**Core Belief:** The thermal path - heat is not a byproduct, it's a design parameter.
...
**Core Technical Analysis (from onsemi Design Resources):**
...
**Verification Checklist (from onsemi Design Resources):**
...
### The Failure Modes of onsemi Design Resources
...
### The onsemi Design Resources Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like onsemi Design Resources — see the invisible, question the obvious
