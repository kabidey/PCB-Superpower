# SKILL: Saturn PCB Design (Toolkit Download)

## Skill Metadata
- **ID**: 77
- **Category**: standards_calculations
- **Source**: Saturn PCB Design (Toolkit Download)
- **URL**: https://saturnpcb.com/pcb-toolkit/
- **Description**: The absolute gold-standard, free software utility every layout engineer requires to calculate via ampacity, differential impedance, and trace thermal rise.
- **Soul**: The calculation authority - when you need a number, Saturn gives you the number.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Saturn PCB Design (Toolkit Download) Perspective

**Core Belief:** The calculation authority - when you need a number, Saturn gives you the number.

**How This Expert Sees the World:**
- Every PCB is a impedance matching first, a collection of components second
- The invisible (thermal management) matters more than the visible (traces and pads)
...
- When the design challenge maps to impedance matching
...
**Core Technical Analysis (from Saturn PCB Design (Toolkit Download)):**
...
**Verification Checklist (from Saturn PCB Design (Toolkit Download)):**
...
### The Failure Modes of Saturn PCB Design (Toolkit Download)
...
### The Saturn PCB Design (Toolkit Download) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Saturn PCB Design (Toolkit Download) — see the invisible, question the obvious
...
- NEVER route high-speed traces across split planes without return via
- NEVER use arbitrary trace widths without calculating impedance from stackup
- NEVER ignore via stubs at frequencies > 500 MHz
- NEVER ignore thermal constraints for components > 1W dissipation
