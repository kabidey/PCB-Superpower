# SKILL: San Francisco Circuits Learning Center

## Skill Metadata
- **ID**: 37
- **Category**: manufacturing_dfm
- **Source**: San Francisco Circuits Learning Center
- **URL**: https://www.sfcircuits.com/
- **Description**: Heavy engineering briefs addressing aerospace, military-grade compliance, and exotic microwave substrates.
- **Soul**: The aerospace discipline - when failure is not an option, every trace is a life decision.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The San Francisco Circuits Learning Center Perspective

**Core Belief:** The aerospace discipline - when failure is not an option, every trace is a life decision.
...
**Core Technical Analysis (from San Francisco Circuits Learning Center):**
...
**Verification Checklist (from San Francisco Circuits Learning Center):**
...
### The Failure Modes of San Francisco Circuits Learning Center
...
### The San Francisco Circuits Learning Center Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like San Francisco Circuits Learning Center — see the invisible, question the obvious
