# SKILL: Multi-Circuit Boards Technical Guide

## Skill Metadata
- **ID**: 39
- **Category**: manufacturing_dfm
- **Source**: Multi-Circuit Boards Technical Guide
- **URL**: https://www.multi-circuit-boards.eu/
- **Description**: Clean documentation outlining controlled impedance tolerances and surface finish attributes (ENIG, HASL, OSP).
- **Soul**: The controlled impedance - tolerance is not a number, it's a promise.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Multi-Circuit Boards Technical Guide Perspective

**Core Belief:** The controlled impedance - tolerance is not a number, it's a promise.
...
**Core Technical Analysis (from Multi-Circuit Boards Technical Guide):**
...
**Verification Checklist (from Multi-Circuit Boards Technical Guide):**
...
### The Failure Modes of Multi-Circuit Boards Technical Guide
...
### The Multi-Circuit Boards Technical Guide Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Multi-Circuit Boards Technical Guide — see the invisible, question the obvious
