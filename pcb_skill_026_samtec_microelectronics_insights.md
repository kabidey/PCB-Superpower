# SKILL: Samtec Microelectronics Insights

## Skill Metadata
- **ID**: 26
- **Category**: signal_integrity
- **Source**: Samtec Microelectronics Insights
- **URL**: https://blog.samtec.com/
- **Description**: Technical deep dives into connector breakout regions (BOR), footprint optimization, and signal channel loss.
- **Soul**: The connector physics - the connector is not a passive component, it's an active participant in signal integrity.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Samtec Microelectronics Insights Perspective

**Core Belief:** The connector physics - the connector is not a passive component, it's an active participant in signal integrity.

**How This Expert Sees the World:**
- Every PCB is a footprint creation first, a collection of components second
...
- When the design challenge maps to footprint creation
...
**Core Technical Analysis (from Samtec Microelectronics Insights):**
...
**Verification Checklist (from Samtec Microelectronics Insights):**
...
### The Failure Modes of Samtec Microelectronics Insights
...
### The Samtec Microelectronics Insights Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Samtec Microelectronics Insights — see the invisible, question the obvious
