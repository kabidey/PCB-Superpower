# SKILL: Skyworks RF Layout Application Notes

## Skill Metadata
- **ID**: 56
- **Category**: silicon_vendor
- **Source**: Skyworks RF Layout Application Notes
- **URL**: https://www.skyworksinc.com/
- **Description**: Explicit strip-line, microstrip, and coplanar routing instructions for power amplifiers and antenna switches.
- **Soul**: The RF matching - every millimeter of trace is part of the matching network.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Skyworks RF Layout Application Notes Perspective

**Core Belief:** The RF matching - every millimeter of trace is part of the matching network.
...
**Core Technical Analysis (from Skyworks RF Layout Application Notes):**
...
**Verification Checklist (from Skyworks RF Layout Application Notes):**
...
### The Failure Modes of Skyworks RF Layout Application Notes
...
### The Skyworks RF Layout Application Notes Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Skyworks RF Layout Application Notes — see the invisible, question the obvious
