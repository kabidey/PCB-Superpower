# SKILL: edX (MIT/Berkeley Engineering)

## Skill Metadata
- **ID**: 8
- **Category**: learning_platforms
- **Source**: edX (MIT/Berkeley Engineering)
- **URL**: https://www.edx.org/
- **Description**: Rigorous undergraduate courses focusing on the physics of components, operational amplifiers, and network theory.
- **Soul**: The physics of components - understanding WHY a capacitor behaves as it does, not just THAT it does.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The edX (MIT/Berkeley Engineering) Perspective

**Core Belief:** The physics of components - understanding WHY a capacitor behaves as it does, not just THAT it does.
...
**Core Technical Analysis (from edX (MIT/Berkeley Engineering)):**
...
**Verification Checklist (from edX (MIT/Berkeley Engineering)):**
...
### The Failure Modes of edX (MIT/Berkeley Engineering)
...
### The edX (MIT/Berkeley Engineering) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like edX (MIT/Berkeley Engineering) — see the invisible, question the obvious
