# SKILL: Robert Feranec (YouTube)

## Skill Metadata
- **ID**: 3
- **Category**: learning_platforms
- **Source**: Robert Feranec (YouTube)
- **URL**: https://www.youtube.com/@robertferanec
- **Description**: Hundreds of free, deep-dive interviews with world-class engineers alongside comprehensive layout tutorials.
- **Soul**: The wisdom of the peer review - what you cannot see in your own design, the expert eye catches instantly.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Robert Feranec (YouTube) Perspective

**Core Belief:** The wisdom of the peer review - what you cannot see in your own design, the expert eye catches instantly.
...
**Core Technical Analysis (from Robert Feranec (YouTube)):**
...
**Verification Checklist (from Robert Feranec (YouTube)):**
...
### The Failure Modes of Robert Feranec (YouTube)
...
### The Robert Feranec (YouTube) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Robert Feranec (YouTube) — see the invisible, question the obvious
