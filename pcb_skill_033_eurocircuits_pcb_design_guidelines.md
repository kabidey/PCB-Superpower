# SKILL: Eurocircuits PCB Design Guidelines

## Skill Metadata
- **ID**: 33
- **Category**: manufacturing_dfm
- **Source**: Eurocircuits PCB Design Guidelines
- **URL**: https://www.eurocircuits.com/
- **Description**: Comprehensive documentation detailing standard panelization layout parameters, microvias, and structural copper balance.
- **Soul**: The European precision - when tolerance is not a suggestion but a contractual obligation.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Eurocircuits PCB Design Guidelines Perspective

**Core Belief:** The European precision - when tolerance is not a suggestion but a contractual obligation.

**How This Expert Sees the World:**
- Every PCB is a via topology optimization first, a collection of components second
...
- When the design challenge maps to via topology optimization
...
**Core Technical Analysis (from Eurocircuits PCB Design Guidelines):**
...
**Verification Checklist (from Eurocircuits PCB Design Guidelines):**
...
### The Failure Modes of Eurocircuits PCB Design Guidelines
...
### The Eurocircuits PCB Design Guidelines Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Eurocircuits PCB Design Guidelines — see the invisible, question the obvious
