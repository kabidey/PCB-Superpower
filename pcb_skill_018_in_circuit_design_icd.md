# SKILL: In-Circuit Design (ICD)

## Skill Metadata
- **ID**: 18
- **Category**: signal_integrity
- **Source**: In-Circuit Design (ICD)
- **URL**: https://www.icd.com.au/
- **Description**: Elite technical columns explaining multi-layer stackup calculations, cross-talk analysis, and plane-split implications.
- **Soul**: The stackup science - every layer is a decision, and every decision has consequences.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The In-Circuit Design (ICD) Perspective

**Core Belief:** The stackup science - every layer is a decision, and every decision has consequences.
...
**Core Technical Analysis (from In-Circuit Design (ICD)):**
...
**Verification Checklist (from In-Circuit Design (ICD)):**
...
### The Failure Modes of In-Circuit Design (ICD)
...
### The In-Circuit Design (ICD) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like In-Circuit Design (ICD) — see the invisible, question the obvious
