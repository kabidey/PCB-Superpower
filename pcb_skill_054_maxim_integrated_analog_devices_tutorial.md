# SKILL: Maxim Integrated (Analog Devices) Tutorials

## Skill Metadata
- **ID**: 54
- **Category**: silicon_vendor
- **Source**: Maxim Integrated (Analog Devices) Tutorials
- **URL**: https://www.analog.com/
- **Description**: Superb engineering articles detailing signal shielding, analog guard rings, and differential skew matching.
- **Soul**: The analog sanctity - in a digital world, the analog section is the temple.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Maxim Integrated (Analog Devices) Tutorials Perspective

**Core Belief:** The analog sanctity - in a digital world, the analog section is the temple.

**How This Expert Sees the World:**
- Every PCB is a differential pair routing first, a collection of components second
...
- When the design challenge maps to differential pair routing
...
**Core Technical Analysis (from Maxim Integrated (Analog Devices) Tutorials):**
...
**Verification Checklist (from Maxim Integrated (Analog Devices) Tutorials):**
...
### The Failure Modes of Maxim Integrated (Analog Devices) Tutorials
...
### The Maxim Integrated (Analog Devices) Tutorials Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Maxim Integrated (Analog Devices) Tutorials — see the invisible, question the obvious
