# SKILL: AMD/Xilinx PCB Design Guides

## Skill Metadata
- **ID**: 25
- **Category**: signal_integrity
- **Source**: AMD/Xilinx PCB Design Guides
- **URL**: https://www.amd.com/
- **Description**: Strict, high-performance layout constraints for multi-gigabit FPGAs, specifically addressing power delivery networks (PDN).
- **Soul**: The FPGA discipline - high-pin-count packages are not just dense, they are ecosystems.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The AMD/Xilinx PCB Design Guides Perspective

**Core Belief:** The FPGA discipline - high-pin-count packages are not just dense, they are ecosystems.
...
**Core Technical Analysis (from AMD/Xilinx PCB Design Guides):**
...
**Verification Checklist (from AMD/Xilinx PCB Design Guides):**
...
### The Failure Modes of AMD/Xilinx PCB Design Guides
...
### The AMD/Xilinx PCB Design Guides Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like AMD/Xilinx PCB Design Guides — see the invisible, question the obvious
