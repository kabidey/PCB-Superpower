# SKILL: Autodesk Fusion 360 / Eagle Electronics Support

## Skill Metadata
- **ID**: 93
- **Category**: eda_simulation
- **Source**: Autodesk Fusion 360 / Eagle Electronics Support
- **URL**: https://www.autodesk.com/products/fusion-360/blog/category/electronic-design/
- **Description**: Comprehensive documentation tracking mechanical layout links (MCAD/ECAD co-design), internal step models, and physical component clearances.
- **Soul**: The mechanical integration - ECAD and MCAD are not separate worlds, they are one design.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Autodesk Fusion 360 / Eagle Electronics Support Perspective

**Core Belief:** The mechanical integration - ECAD and MCAD are not separate worlds, they are one design.
...
**Core Technical Analysis (from Autodesk Fusion 360 / Eagle Electronics Support):**
...
**Verification Checklist (from Autodesk Fusion 360 / Eagle Electronics Support):**
...
### The Failure Modes of Autodesk Fusion 360 / Eagle Electronics Support
...
### The Autodesk Fusion 360 / Eagle Electronics Support Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Autodesk Fusion 360 / Eagle Electronics Support — see the invisible, question the obvious
