# SKILL: EEVblog (YouTube)

## Skill Metadata
- **ID**: 5
- **Category**: learning_platforms
- **Source**: EEVblog (YouTube)
- **URL**: https://www.youtube.com/@EEVblog
- **Description**: Dave Jones’ classic channel delivering raw engineering insights, PCB teardowns, and blunt layout reviews.
...
### The EEVblog (YouTube) Perspective
...
**Core Technical Analysis (from EEVblog (YouTube)):**
...
**Verification Checklist (from EEVblog (YouTube)):**
...
### The Failure Modes of EEVblog (YouTube)
...
### The EEVblog (YouTube) Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like EEVblog (YouTube) — see the invisible, question the obvious
