# SKILL: EMC for Product Designers

## Skill Metadata
- **ID**: 83
- **Category**: standards_calculations
- **Source**: EMC for Product Designers
- **URL**: N/A (Book)
- **Description**: Tim Williams' complete engineering playbook detailing how to lay out boards that clear regulatory emissions limits (FCC/CE).
- **Soul**: The regulatory reality - FCC and CE are not suggestions, they are laws.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The EMC for Product Designers Perspective

**Core Belief:** The regulatory reality - FCC and CE are not suggestions, they are laws.
...
**Core Technical Analysis (from EMC for Product Designers):**
...
**Verification Checklist (from EMC for Product Designers):**
...
### The Failure Modes of EMC for Product Designers
...
### The EMC for Product Designers Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like EMC for Product Designers — see the invisible, question the obvious
