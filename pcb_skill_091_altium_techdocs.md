# SKILL: Altium TechDocs

## Skill Metadata
- **ID**: 91
- **Category**: eda_simulation
- **Source**: Altium TechDocs
- **URL**: https://www.altium.com/documentation
- **Description**: Exceptionally detailed layout reference documentation explaining length matching, xSignals, tuning paths, and accordion routing configurations.
- **Soul**: The tool mastery - every feature has a purpose, and every purpose has a document.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Altium TechDocs Perspective

**Core Belief:** The tool mastery - every feature has a purpose, and every purpose has a document.
...
**Core Technical Analysis (from Altium TechDocs):**
...
**Verification Checklist (from Altium TechDocs):**
...
### The Failure Modes of Altium TechDocs
...
### The Altium TechDocs Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Altium TechDocs — see the invisible, question the obvious
