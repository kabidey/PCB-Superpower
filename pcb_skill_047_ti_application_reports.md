# SKILL: TI Application Reports

## Skill Metadata
- **ID**: 47
- **Category**: silicon_vendor
- **Source**: TI Application Reports
- **URL**: https://www.ti.com/
- **Description**: Comprehensive library showing exact step-down switching regulator loops and operational amplifier layout guidelines.
- **Soul**: The unique perspective of TI Application Reports - a lens through which PCB design problems are seen, analyzed, and solved.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The TI Application Reports Perspective

**Core Belief:** The unique perspective of TI Application Reports - a lens through which PCB design problems are seen, analyzed, and solved.
...
**Core Technical Analysis (from TI Application Reports):**
...
**Verification Checklist (from TI Application Reports):**
...
### The Failure Modes of TI Application Reports
...
### The TI Application Reports Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like TI Application Reports — see the invisible, question the obvious
