# SKILL: Littelfuse ESD Protection Layout Guide

## Skill Metadata
- **ID**: 59
- **Category**: silicon_vendor
- **Source**: Littelfuse ESD Protection Layout Guide
- **URL**: https://www.littelfuse.com/
- **Description**: Strict rules dictating precise, low-inductance component placement for TVS clamping diodes adjacent to line entry ports.
- **Soul**: The ESD protection - TVS diodes are insurance policies, and placement is the premium.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Littelfuse ESD Protection Layout Guide Perspective

**Core Belief:** The ESD protection - TVS diodes are insurance policies, and placement is the premium.
...
**Core Technical Analysis (from Littelfuse ESD Protection Layout Guide):**
...
**Verification Checklist (from Littelfuse ESD Protection Layout Guide):**
...
### The Failure Modes of Littelfuse ESD Protection Layout Guide
...
### The Littelfuse ESD Protection Layout Guide Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Littelfuse ESD Protection Layout Guide — see the invisible, question the obvious
