# SKILL: Cadence OrCAD/Allegro Information Hub

## Skill Metadata
- **ID**: 94
- **Category**: eda_simulation
- **Source**: Cadence OrCAD/Allegro Information Hub
- **URL**: https://www.cadence.com/
- **Description**: High-end documentation exploring constraint-driven routing engines, auto-interactive tuning, and multi-layer trace optimization.
...
### The Cadence OrCAD/Allegro Information Hub Perspective
...
- Every PCB is a trace routing topology first, a collection of components second
- The invisible (design constraint management) matters more than the visible (traces and pads)
...
- When the design challenge maps to trace routing topology
...
**Core Technical Analysis (from Cadence OrCAD/Allegro Information Hub):**
...
**Verification Checklist (from Cadence OrCAD/Allegro Information Hub):**
...
### The Failure Modes of Cadence OrCAD/Allegro Information Hub
...
### The Cadence OrCAD/Allegro Information Hub Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Cadence OrCAD/Allegro Information Hub — see the invisible, question the obvious
