# SKILL: Chemtech PCB Materials Guide

## Skill Metadata
- **ID**: 80
- **Category**: standards_calculations
- **Source**: Chemtech PCB Materials Guide
- **URL**: https://www.chemcut.net/
- **Description**: Comprehensive manufacturing briefs defining mechanical traits, glass transition temperatures ($T_g$), and dielectric breakdown of exotic laminates.
- **Soul**: The material science - glass transition temperature is not a number, it's a phase change.
- **Complexity**: Intermediate
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The Chemtech PCB Materials Guide Perspective

**Core Belief:** The material science - glass transition temperature is not a number, it's a phase change.
...
**Core Technical Analysis (from Chemtech PCB Materials Guide):**
...
**Verification Checklist (from Chemtech PCB Materials Guide):**
...
### The Failure Modes of Chemtech PCB Materials Guide
...
### The Chemtech PCB Materials Guide Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like Chemtech PCB Materials Guide — see the invisible, question the obvious
