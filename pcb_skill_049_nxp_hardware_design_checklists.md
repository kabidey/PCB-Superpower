# SKILL: NXP Hardware Design Checklists

## Skill Metadata
- **ID**: 49
- **Category**: silicon_vendor
- **Source**: NXP Hardware Design Checklists
- **URL**: https://www.nxp.com/
- **Description**: Explicit layout rule matrices for routing industrial communication buses like CAN-bus, Ethernet, and high-speed USB.
- **Soul**: The industrial communication - CAN bus and Ethernet are not wires, they are protocols with physical requirements.
- **Complexity**: Advanced
- **Confidence Threshold**: 0.7

## MENTAL MODEL (How to Think Like This Expert)
### The NXP Hardware Design Checklists Perspective

**Core Belief:** The industrial communication - CAN bus and Ethernet are not wires, they are protocols with physical requirements.
...
**Core Technical Analysis (from NXP Hardware Design Checklists):**
...
**Verification Checklist (from NXP Hardware Design Checklists):**
...
### The Failure Modes of NXP Hardware Design Checklists
...
### The NXP Hardware Design Checklists Superpower
...
**Activation Ritual:**
1. **Adopt the Mental Model:** Think like NXP Hardware Design Checklists — see the invisible, question the obvious
